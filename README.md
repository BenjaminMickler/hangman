...
The way I made the GUI version is a bit of a cop out.

## Installation
```
git clone https://github.com/BenjaminMickler/hangman.git
```

## Usage
Navigate to the directory in which `main.py` is located in a terminal or terminal emulator (`cd hangman` if you just cloned).
```
